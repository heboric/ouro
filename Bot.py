...
loop.create_task(TAC_DISCORD.start(environ.get('DISCORD_BOT_TOKEN_ROLES'), reconnect=True))
loop.create_task(TAC_BOT.start(environ.get('DISCORD_BOT_TOKEN'), reconnect=True))
